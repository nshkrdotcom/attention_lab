...
def _render_run_index_markdown(experiment_id: str, rows: list[dict[str, Any]]) -> str:
    lines = [
        ...
        "",
        "| run | attention | stage | status | promotion | approved | report | blockers | screen loss | screen active | screen diag | killed_at | kill_reason | overwrite | requires | mechanism_check | failure | step | final loss | best loss | ppl | tok/s | vram MB | hs | active | classification | notes |",
        "| --- | --- | --- | --- | --- | --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |",
    ]
    for row in rows:
        lines.append(
            ...
            + " | ".join(
                [
                    ...
                    _md(row.get("killed_at")),
                    _md(row.get("kill_reason")),
